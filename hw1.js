...

{
    ...
    if ((mRest10 === 0) || (5 <= mRest10 && mRest10 <= 9) || (11 <= mRest100 && mRest100 <= 19)) { // 1) закінчуються на 0 (10, 20, 30, 40, 280, 50500; 2) закінчуються на 5-9; 3) закінчуються на 11-19
        meters = (m + ' метрів');
    } else if (2 <= mRest10 && mRest10 <= 4) { // закінчуються на 2, 3, 4 (не важливо чи є дроби) 
        meters = (m + ' метри');
    } else if (mRest100 < 1) { // будь який дріб менше 1, не повний км
        meters = (m + ' метра');
    } else if (mRest10 === 1) { // закінчується на 1, окрім 11 (бо 11, 111, 1111 входить в інший if вище)
        meters = (m + ' метр');
    };
    
    if ((kmRest10 === 0) || (5 <= kmRest10 && kmRest10 <= 9) || (11 <= kmRest100 && kmRest100 <= 19)) { // 1) закінчуються на 0 (10, 20, 30, 40, 280, 50500; 2) закінчуються на 5-9; 3) закінчуються на 11-19
        kilometers = (km + ' кілометрів');
    } else if (2 <= kmRest10 && kmRest10 <= 4) { // закінчуються на 2, 3, 4 (не важливо чи є дроби) 
        kilometers = (km + ' кілометри');
    } else if (kmRest100 < 1) { // будь який дріб менше 1, не повний км
